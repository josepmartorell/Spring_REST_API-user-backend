...
import com.crud.h2.payload.request.LoginRequest;
import com.crud.h2.payload.request.SignupRequest;
import com.crud.h2.payload.response.MessageResponse;
import com.crud.h2.payload.response.UserInfoResponse;
import com.crud.h2.security.jwt.JwtUtils;
import com.crud.h2.security.services.UserDetailsImpl;
    ...
    if (strRoles == null) {
      ...
      strRoles.forEach(role -> {
        ...
        case "admin":
          ...
          break;
        case "mod":
          Role modRole = iRoleDAO.findByName(ERole.ROLE_MODERATOR)
              .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
          roles.add(modRole);
